    ...
    do
        ...
        do
            ...
            do
                ...
                pre_w=$model_card"_"$data"_repbert_"$fold"_e30_seed"$random_seed"_blr1e-5_nblr1e-4"
                exp="Glow_sw_"$n_block$n_flow$glow_lr"_Prefix0001e-4_LoRA0001e-4_e"$MAX_EPOCH"_seed"$random_seed
